 ...
 */
@Entity
public class DisponibiliteSalle implements Serializable {
    ...
    public DisponibiliteSalle(int numSem, StatutSalle statut) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DisponibiliteSalle)) {
            return false;
        }
        DisponibiliteSalle other = (DisponibiliteSalle) object;
    ...
    public String toString() {
        return "appPatrimoine.entities.DisponibiliteSalle[ id=" + id + " ]";
    }
